...
CREATE TABLE family (
  ...
  id_user            INT NOT NULL UNIQUE,  -- clé étrangère vers USER (ASSOCIER)
  created_at         TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  updated_at         TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE association (
  ...
  profile_photo      VARCHAR(255),
  id_user            INT NOT NULL UNIQUE,  -- clé étrangère vers USER (DEFINIR)
  created_at         TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  updated_at         TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE animal (
  ...
  photo2           VARCHAR(255),
  photo3           VARCHAR(255),
  id_family        INT,      -- clé étrangère vers FAMILY (HEBERGER)
  id_association   INT NOT NULL,  -- clé étrangère vers ASSOCIATION (DETENIR)
  created_at       TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  updated_at       TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);

CREATE TABLE ask (
  id SERIAL PRIMARY KEY,  -- Ajout d'une clé primaire
