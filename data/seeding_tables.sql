...
('Dupont', 'Jean', 'jean.dupont@email.com', 'password1', 'family'),
('Martin', 'Sophie', 'sophie.martin@email.com', 'password2', 'family'),
('Durand', 'Hugo', 'hugo.durand@email.com', 'password3', 'family'),
('Leroy', 'Léa', 'lea.leroy@email.com', 'password4', 'family'),
('Moreau', 'Luc', 'luc.moreau@email.com', 'password5', 'family'),
('Dubois', 'Pierre', 'pierre.dubois@email.com', 'password6', 'association'),
('Lefebvre', 'Marie', 'marie.lefebvre@email.com', 'password7', 'association'),
('Bernard', 'Alice', 'alice.bernard@email.com', 'password8', 'association'),
('Thomas', 'Paul', 'paul.thomas@email.com', 'password9', 'association'),
('Robert', 'Emma', 'emma.robert@email.com', 'password10', 'association'),
('Giraud', 'Antoine', 'antoine.giraud@email.com', 'password11', 'family'),
('Henry', 'Camille', 'camille.henry@email.com', 'password12', 'family'),
('Simon', 'Nicolas', 'nicolas.simon@email.com', 'password13', 'family'),
('Roussel', 'Julie', 'julie.roussel@email.com', 'password14', 'family'),
('Bourgeois', 'Philippe', 'philippe.bourgeois@email.com', 'password15', 'family'),
('Morin', 'Lucie', 'lucie.morin@email.com', 'password16', 'association'),
('Vasseur', 'Julien', 'julien.vasseur@email.com', 'password17', 'family'),
('Meyer', 'Clara', 'clara.meyer@email.com', 'password18', 'family'),
('Collet', 'Maxime', 'maxime.collet@email.com', 'password19', 'association'),
('Aubert', 'Cécile', 'cecile.aubert@email.com', 'password20', 'association'),
('Pichon', 'Louis', 'louis.pichon@email.com', 'password21', 'association'),
('Morel', 'Lucie', 'lucie.morel@email.com', 'password22', 'family'),
('Garnier', 'Raphaël', 'raphael.garnier@email.com', 'password23', 'association'),
('David', 'Alice', 'alice.david@email.com', 'password24', 'family'),
('Durand', 'Hugo', 'hugo.durand@email.com', 'password3', 'family');
...
('Toby', 'Chat', 'Himalayen', 'M', 5, 'Grand', 'Chat calme et doux', 'images/animals_profile/71.webp', 'images/animals_photo1/71.webp', 'images/animals_photo2/71.webp', 'images/animals_photo3/71.webp', 7),
('Misty', 'Chat', 'Oriental à poil court', 'F', 3, 'Moyen', 'Chat sociable et affectueux', 'images/animals_profile/72.webp', 'images/animals_photo1/72.webp', 'images/animals_photo2/72.webp', 'images/animals_photo3/72.webp', 7),
('Rusty', 'Chat', 'Mau Égyptien', 'M', 5, 'Moyen', 'Chat énergique et curieux', 'images/animals_profile/85.webp', 'images/animals_photo1/85.webp', 'images/animals_photo2/85.webp', 'images/animals_photo3/85.webp', 9),
...
('Rocky', 'Chien', 'Husky de Sibérie', 'M', 6, 'Grand', 'Chien énergique et aventurier', 'images/animals_profile/91.webp', 'images/animals_photo1/91.webp', 'images/animals_photo2/91.webp', 'images/animals_photo3/91.webp', 10),
('Chloe', 'Chien', 'Cavalier King Charles', 'F', 2, 'Petit', 'Chienne affectueuse et douce', 'images/animals_profile/92.webp', 'images/animals_photo1/92.webp', 'images/animals_photo2/92.webp', 'images/animals_photo3/92.webp', 10),
('Jasper', 'Chat', 'Siamois', 'M', 3, 'Moyen', 'Chat vocal et social', 'images/animals_profile/93.webp', 'images/animals_photo1/93.webp', 'images/animals_photo2/93.webp', 'images/animals_photo3/93.webp', 10),
...
('Bella', 'Chien', 'Spitz nain', 'F', 1, 'Petit', 'Chienne vive et espiègle', 'images/animals_profile/96.webp', 'images/animals_photo1/96.webp', 'images/animals_photo2/96.webp', 'images/animals_photo3/96.webp', 10),
('Rusty', 'Chat', 'Mau Égyptien', 'M', 5, 'Moyen', 'Chat énergique et curieux', 'images/animals_profile/85.webp', 'images/animals_photo1/85.webp', 'images/animals_photo2/85.webp', 'images/animals_photo3/85.webp', 9),
('Pip', 'Chat', 'Khao Manee', 'F', 2, 'Petit', 'Chat joyeux et joueur', 'images/animals_profile/86.webp', 'images/animals_photo1/86.webp', 'images/animals_photo2/86.webp', 'images/animals_photo3/86.webp', 9),
('Bailey', 'Chien', 'Beagle', 'M', 3, 'Moyen', 'Chien curieux et plein d''énergie', 'images/animals_profile/87.webp', 'images/animals_photo1/87.webp', 'images/animals_photo2/87.webp', 'images/animals_photo3/87.webp', 10),
('Daisy', 'Chien', 'Golden Retriever', 'F', 4, 'Grand', 'Chienne douce et amicale', 'images/animals_profile/88.webp', 'images/animals_photo1/88.webp', 'images/animals_photo2/88.webp', 'images/animals_photo3/88.webp', 10),
