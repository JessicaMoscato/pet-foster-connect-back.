...
router.patch("/:id",verifyToken, isRoleAuthorizedMiddleware(["association"]), validate(patchSchema, "body"), withTryCatch(associationController.patchAssociation));
router.delete("/:id",verifyToken, isRoleAuthorizedMiddleware(["association"]), withTryCatch(associationController.deleteAssociation))